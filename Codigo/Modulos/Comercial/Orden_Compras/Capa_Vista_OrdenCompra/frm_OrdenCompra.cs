...
namespace Capa_Vista_OrdenCompra
{
    public partial class frm_OrdenCompra : Form
    {
        ...
        public frm_OrdenCompra()
        {
            ...
            tayudaOC.SetToolTip(Btn_AyudaC, "Ayuda");
        ...
        */
        ...
        private void Btn_AyudaC_Click(object sender, EventArgs e)
        {
            try
            {
                // Ruta para el archivo de ayuda dentro de la estructura del proyecto

                string sAyudaPath = Path.Combine(sRutaProyectoAyuda, "Ayuda", "Modulos", "Comercial", "AyudaCompras", "AyudaCp.chm");

                // Verifica si el archivo existe antes de intentar abrirlo
                if (File.Exists(sAyudaPath))
                {
                    Help.ShowHelp(this, sAyudaPath, "CompraAyuda.html");
                }
                else
                {
        ...
        private void Btn_reporteOC_Click(object sender, EventArgs e)
        {
